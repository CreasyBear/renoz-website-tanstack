...
function AccordionSteps({ steps, title }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-full", children: [
    title && /* @__PURE__ */ jsx("h2", { className: "text-3xl md:text-4xl font-bold mb-8 text-[var(--black)]", children: title }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-8", children: [
      /* @__PURE__ */ jsx("div", { className: "flex-1 space-y-4", children: steps.map((step, index) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(AnimatePresence, { children: openIndex === index && /* @__PURE__ */ jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxs("div", { className: "pl-12 md:pl-16 pr-4 pb-4 pt-2", children: [
                  /* @__PURE__ */ jsx("p", { className: "text-[var(--text-muted)] text-lg leading-relaxed", children: step.content }),
                  step.image && /* @__PURE__ */ jsx("div", { className: "lg:hidden mt-6 rounded-2xl overflow-hidden aspect-video relative", children: /* @__PURE__ */ jsx(
                    Image,
                    {
                      src: step.image,
                      alt: step.title,
      ...
      /* @__PURE__ */ jsx("div", { className: "hidden lg:block flex-1 relative h-[500px]", children: /* @__PURE__ */ jsx("div", { className: "sticky top-8 w-full h-full rounded-[32px] overflow-hidden bg-gray-100 shadow-soft", children: /* @__PURE__ */ jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxs(
        motion.div,
        {

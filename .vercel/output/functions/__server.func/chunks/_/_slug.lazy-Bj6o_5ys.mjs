...
import { c as createLazyFileRoute, u as useScroll, b as useTransform, m as motion, d as Sun, a as createLucideIcon, S as Shield, Z as Zap, B as Button } from "./router-CNMZyROD.mjs";
...
function CaseStudyDetailPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[var(--white-warm)]", ref: containerRef, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-[90vh] overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[var(--black)] text-white py-16 md:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-12 divide-y md:divide-y-0 md:divide-x divide-white/10", children: study.results.map((result, i) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white py-16 md:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-16 items-center mb-24", children: [

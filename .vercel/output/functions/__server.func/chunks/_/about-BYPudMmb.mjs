...
import { V as VerticalTimeline } from "./VerticalTimeline-DAkW71NW.mjs";
import { m as motion, a as createLucideIcon, T as Thermometer, Z as Zap, S as Shield, k as AnimatePresence, X, g as cn } from "./router-CQGIo6hj.mjs";
...
function AboutPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[var(--white-warm)]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "section-spacing bg-[var(--cream)] relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: [
      ...
      }].map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "snap-center shrink-0 w-[85vw]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative overflow-hidden rounded-[32px] p-8 h-[350px] flex flex-col justify-between shadow-xl`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "section-spacing bg-[var(--cream)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden flex overflow-x-auto snap-x snap-mandatory gap-4 px-4 -mx-4 hide-scrollbar pb-8", children: teamMembers.map((member, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "snap-center shrink-0 w-[70vw]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group cursor-pointer h-full", onClick: () => setSelectedMember(member), children: [

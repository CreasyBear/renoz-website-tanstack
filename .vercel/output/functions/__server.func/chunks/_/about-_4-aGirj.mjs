...
import { V as VerticalTimeline } from "./VerticalTimeline-BAe2NvzU.mjs";
import { m as motion, a as createLucideIcon, x as Thermometer, Z as Zap, S as Shield, k as AnimatePresence, X, g as cn } from "./router-CNMZyROD.mjs";
...
function AboutPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[var(--white-warm)]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-[60vh] min-h-[500px] flex items-center overflow-hidden bg-[var(--black)] text-[var(--text-on-dark)]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 md:py-32 bg-[var(--white-warm)] overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-12 gap-12 lg:gap-20 items-start", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: "lg:col-span-5 relative mt-8 lg:mt-24", initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-6 -right-6 w-32 h-32 bg-[var(--renoz-green)]/10 -z-10" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-6 -left-6 w-32 h-32 border border-gray-200 -z-10" })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-24 md:py-32 bg-[#050505] text-white relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-16 lg:gap-24 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-lg text-gray-400 font-light leading-relaxed", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-[var(--cream)] relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6 lg:gap-8", children: [{
        title: "Resilience.",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 md:py-32 bg-black text-white relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-end justify-between mb-12 gap-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 max-w-sm text-lg text-right md:text-left", children: "Go inside our Perth facility and see how we engineer resilience." })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-[var(--cream)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(VerticalTimeline, { title: "Our Journey", highlightLast: true, steps: [{
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-white border-b border-gray-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-[var(--cream)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 lg:gap-8", children: teamMembers.map((member, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: "group cursor-pointer", initial: {
        opacity: 0,
        y: 20
      }, whileInView: {
        opacity: 1,

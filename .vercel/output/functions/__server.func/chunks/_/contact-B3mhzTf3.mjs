...
import { p as Route$a, u as useScroll, b as useTransform, m as motion, g as cn, a as createLucideIcon, B as Button, A as ArrowRight, P as Phone, q as Mail, s as MapPin, C as ChevronDown, k as AnimatePresence, S as Shield, L as Link } from "./router-DIqr-Eg3.mjs";
...
import { H as HardHat } from "./hard-hat-UMCSrag2.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24 -mt-24 relative z-20", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 md:mt-20 lg:mt-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden flex overflow-x-auto snap-x snap-mandatory gap-4 px-4 -mx-4 hide-scrollbar pb-8", children: [{
          ...
          step: "03"
        }].map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "snap-center shrink-0 w-[85vw]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-6 border border-gray-100 shadow-sm h-full flex flex-col", children: [

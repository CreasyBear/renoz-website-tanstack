...
import { p as Route$a, u as useScroll, b as useTransform, m as motion, g as cn, a as createLucideIcon, B as Button, A as ArrowRight, P as Phone, q as Mail, s as MapPin, C as ChevronDown, k as AnimatePresence, S as Shield, L as Link } from "./router-Dr9vd5LV.mjs";
...
import { H as HardHat } from "./hard-hat-CCbE73Mz.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-[60vh] min-h-[500px] flex items-center overflow-hidden bg-[var(--black)] text-white", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full pt-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
          ...
          duration: 0.8,
          delay: 0.2
        }, className: "glass-dark p-6 md:p-8 rounded-2xl max-w-2xl border-l-4 border-[var(--renoz-green)] shadow-2xl backdrop-blur-xl bg-black/40 mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl md:text-2xl text-zinc-100 font-normal leading-relaxed", children: "Whether you're a homeowner, installer, or developer, our Perth-based engineering team is ready to help." }) })
      ] }) })
    ] }),

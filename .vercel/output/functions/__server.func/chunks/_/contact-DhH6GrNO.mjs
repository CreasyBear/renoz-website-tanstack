...
import { p as Route$a, u as useScroll, b as useTransform, m as motion, g as cn, a as createLucideIcon, B as Button, A as ArrowRight, P as Phone, q as Mail, s as MapPin, C as ChevronDown, k as AnimatePresence, S as Shield, L as Link } from "./router-CNMZyROD.mjs";
...
import { H as HardHat } from "./hard-hat-BszI254x.mjs";
...
function ContactPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[var(--cream)]", ref: containerRef, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-[60vh] min-h-[500px] flex items-center overflow-hidden bg-[var(--black)] text-white", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full pt-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl md:text-2xl text-white/90 max-w-2xl font-light leading-relaxed drop-shadow-md", children: "Whether you're a homeowner, installer, or developer, our Perth-based engineering team is ready to help." })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24 -mt-24 relative z-20", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
        opacity: 0,
        y: 30
      }, whileInView: {
        opacity: 1,
        ...
        duration: 0.8
      }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(VerticalTimeline, { title: "What happens next?", steps: [{
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-32 max-w-4xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: faqs.map((faq, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: openFaq === i && /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
            ...
            height: 0,
            opacity: 0
          }, className: "overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pb-6 md:px-8 md:pb-8 text-[var(--text-muted)] leading-relaxed border-t border-gray-50 pt-4", children: faq.a }) }) })
        ] }, i)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mt-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
        opacity: 0,
        y: 30
      }, whileInView: {
        opacity: 1,

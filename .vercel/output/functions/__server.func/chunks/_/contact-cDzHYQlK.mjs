...
import { p as Route$a, i as useScroll, j as useTransform, m as motion, a as cn, c as createLucideIcon, B as Button, h as ArrowRight, P as Phone, q as Mail, s as MapPin, C as ChevronDown, A as AnimatePresence, g as Shield, L as Link } from "./router-DA_nET4b.mjs";
import { C as Card } from "./Card-D6zwY_aS.mjs";
import { T as Turnstile, C as ChevronUp } from "./Turnstile-Chg_QIX7.mjs";
import { V as VerticalTimeline } from "./VerticalTimeline-DtM_Qzel.mjs";
import { H as HardHat } from "./hard-hat-m6uX5uR5.mjs";
...
const inquirySchema = objectType({
  name: stringType().min(1, "Please enter your full name so we can address you properly").max(100, "Name too long").regex(/^[^<>"'&]*$/, "Invalid characters in name"),
  email: stringType().min(5, "Email too short").max(254, "Email too long").regex(/^[^\s@]+@[^\s@]+\.[^\s@]+$/, "Invalid email format").refine((email) => !email.includes("<") && !email.includes(">") && !email.includes('"'), "Invalid characters in email"),
  company: stringType().max(100, "Company name too long").regex(/^[^<>"'&]*$/, "Invalid characters in company name"),
  inquiry_type: stringType().min(1, "Please select an inquiry type"),
  message: stringType().min(10, "Please provide more details about your energy needs (minimum 10 characters)").max(2e3, "Message too long").regex(/^[^<>"'&]*$/, "Invalid characters in message"),
  turnstileToken: stringType().min(1, "Please complete the spam check"),
  // Honeypot field - should be empty for legitimate users
  website: stringType().max(0, "Spam detected")
});
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { className: "lg:col-span-7", initial: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(form.Field, { name: "company", children: (field) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(form.Subscribe, { selector: (state) => [state.values.inquiry_type], children: ([inquiryType]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: companyId, value: field.state.value, onBlur: field.handleBlur, onChange: (e) => field.handleChange(e.target.value), className: "w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[var(--renoz-green)] focus:border-transparent outline-none transition-all placeholder:text-gray-400", placeholder: inquiryType === "residential" ? "Your suburb or address" : "Your business name", maxLength: 100, autoComplete: inquiryType === "residential" ? "address-line1" : "organization" })
            ] }) }) }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(form.Field, { name: "website", children: (field) => /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", name: "website", value: field.state.value, onChange: (e) => field.handleChange(e.target.value), style: {
              display: "none"
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(form.Field, { name: "turnstileToken", children: (field) => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Turnstile, { ref: turnstileRef, siteKey: "0x4AAAAAABHX5BtfeC3UIcgA", onVerify: (token) => field.handleChange(token), onError: () => field.handleChange(""), onReset: () => field.handleChange(""), theme: "auto", size: "normal", className: "flex justify-center" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(form.Subscribe, { selector: (state) => [state.canSubmit], children: ([canSubmit]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { type: "submit", variant: "primary", size: "lg", className: "w-full rounded-xl py-4 text-lg shadow-lg shadow-[var(--renoz-green)]/20", disabled: !canSubmit || false || submitStatus === "submitting" || isSubmitting, "aria-describedby": "submit-status", children: [

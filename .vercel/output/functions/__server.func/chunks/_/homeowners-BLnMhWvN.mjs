...
import { m as motion, B as Button, l as SolarEconomics, S as Shield, n as MasonryGallery, o as getCaseStudySubset, g as cn, I as Image, d as Sun, M as Moon } from "./router-CNMZyROD.mjs";
...
import { D as DollarSign } from "./dollar-sign-BeD5cjJV.mjs";
...
function HomeownersPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[var(--cream)]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-[var(--white-warm)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-3 gap-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { hover: true, className: "p-8 border-none bg-[var(--black)] text-white hover:bg-gray-900 transition-colors duration-300 shadow-xl transform md:-translate-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 leading-relaxed", children: "When the grid goes down, your RENOZ system instantly takes over. Keep your lights, internet, and fridge running seamlessly." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { hover: true, className: "p-8 border-none bg-white hover:shadow-lg transition-all duration-300", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(VerticalTimeline, { title: "The path to independence.", steps: [{
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-[var(--white-warm)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MasonryGallery, { title: "Join your neighbors.", showRating: true, images: getCaseStudySubset(3) }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-32 bg-[var(--black)] text-white text-center relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 relative z-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-6 justify-center items-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm font-medium uppercase tracking-widest mt-4 sm:mt-0 sm:ml-4", children: "10-Year Warranty included" })
        ] })
      ] })
    ] })
  ] });

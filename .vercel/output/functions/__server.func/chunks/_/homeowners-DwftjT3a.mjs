...
import { m as motion, B as Button, l as SolarEconomics, g as Shield, n as MasonryGallery, o as getCaseStudySubset, a as cn, I as Image, k as Sun, M as Moon } from "./router-CcuDqJxU.mjs";
...
import { D as DollarSign } from "./dollar-sign-C_0ERhWO.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[var(--cream)]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "section-spacing bg-[var(--white-warm)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden flex overflow-x-auto snap-x snap-mandatory gap-4 px-4 -mx-4 hide-scrollbar pb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "snap-center shrink-0 w-[85%] max-w-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "h-full p-6 border-none bg-white shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "snap-center shrink-0 w-[85%] max-w-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "h-full p-6 border-none bg-[var(--black)] text-white shadow-xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "section-spacing bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: (() => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden flex overflow-x-auto snap-x snap-mandatory gap-4 px-4 -mx-4 hide-scrollbar pb-8", children: steps.map((step, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "snap-center shrink-0 w-[85%] max-w-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl overflow-hidden shadow-sm h-full flex flex-col", children: [

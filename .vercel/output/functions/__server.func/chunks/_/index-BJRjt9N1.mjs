...
import { u as useScroll, b as useTransform, m as motion, B as Button, A as ArrowRight, l as SolarEconomics, I as Image, s as MapPin, S as Shield, Z as Zap, y as InverterMarquee, z as Star, n as MasonryGallery, o as getCaseStudySubset, L as Link, g as cn, k as AnimatePresence, a as createLucideIcon, d as Sun, C as ChevronDown } from "./router-DL48cnRL.mjs";
...
import { Q as Quote } from "./quote-B9KEf9dc.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[var(--cream)] font-sans selection:bg-[var(--renoz-green)] selection:text-white", ref: containerRef, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-[100svh] md:h-screen min-h-[600px] md:min-h-[800px] flex items-center overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full pt-20 md:pt-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight mb-6 md:mb-10 text-white leading-[0.9]", children: [
          "Your solar makes power. ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
          ...
          delay: 0.3,
          ease: "easeOut"
        }, className: "glass-dark p-6 md:p-8 rounded-2xl mb-8 md:mb-12 max-w-lg border-l-4 border-[var(--renoz-green)] shadow-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg md:text-xl text-zinc-100 leading-relaxed font-light", children: [
          "Most WA homes ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-medium", children: "lose 70% of their solar" }),
          " back to the grid for cents. Our batteries let you store it and use it when power costs the most."
        ] }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        duration: 1,
        delay: 0.8
      }, className: "absolute bottom-6 left-4 right-4 md:bottom-12 md:left-auto md:right-12 flex flex-row md:flex-row gap-3 md:gap-4 z-20 justify-center md:justify-end", children: [

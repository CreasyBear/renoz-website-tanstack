...
import { u as useScroll, b as useTransform, m as motion, B as Button, A as ArrowRight, l as SolarEconomics, I as Image, s as MapPin, S as Shield, Z as Zap, y as InverterMarquee, z as Star, n as MasonryGallery, o as getCaseStudySubset, L as Link, g as cn, k as AnimatePresence, a as createLucideIcon, d as Sun, C as ChevronDown } from "./router-C_4ih4eM.mjs";
import { F as Flame } from "./flame-fbox4yD3.mjs";
import { A as AccordionSteps } from "./AccordionSteps-8im5lLzr.mjs";
...
import { Q as Quote } from "./quote-Cq5Q2Gou.mjs";
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[var(--cream)] font-sans selection:bg-[var(--renoz-green)] selection:text-white", ref: containerRef, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-screen min-h-[800px] flex items-center overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full pt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        opacity: 0,
        x: -50
      }, animate: {
        opacity: 1,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center px-3 py-1 rounded-full border border-white/20 text-white text-xs font-bold tracking-widest uppercase bg-white/5 backdrop-blur-md shadow-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-[var(--renoz-green)] mr-2 animate-pulse" }),
            "OEM Manufacturer"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/80 text-sm font-medium tracking-wide", children: "Perth, Western Australia" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-3xl md:text-5xl lg:text-7xl xl:text-8xl font-bold mb-6 md:mb-8 text-white leading-[0.95] tracking-tight", children: [
          "Like a ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-transparent bg-clip-text bg-gradient-to-r from-sky-300 to-blue-500", children: "rainwater tank" }),
          " for your ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-transparent bg-clip-text bg-gradient-to-r from-[var(--renoz-green)] via-[var(--renoz-green-light)] to-white", children: "solar system." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
          ...
          delay: 0.2,
          ease: "easeOut"
        }, className: "glass-dark p-6 md:p-8 rounded-2xl mb-12 max-w-xl border-l-4 border-[var(--renoz-green)] shadow-2xl backdrop-blur-xl bg-black/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xl md:text-2xl text-zinc-100 font-normal leading-relaxed", children: [
          "Free power falls on your roof every day. ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "Catch it. Keep it."
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "primary", size: "lg", to: "/case-studies", className: "group text-lg px-8 rounded-full", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", size: "lg", to: "/contact", className: "text-lg px-8 rounded-full backdrop-blur-md bg-transparent border-white/30 text-white hover:bg-white hover:text-black transition-all", children: "Talk to an Expert" })
        ] })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-dark p-6 rounded-2xl min-w-[200px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-bold text-white mb-1", children: "100%+" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[var(--renoz-green)] uppercase tracking-widest", children: "Energy Resilience" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-dark p-6 rounded-2xl min-w-[200px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-bold text-white mb-1", children: "10 Year" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[var(--renoz-green)] uppercase tracking-widest", children: "Replacement Warranty" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SolarEconomics, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-12 md:py-20 lg:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative z-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        opacity: 0,
        y: 40
      }, whileInView: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-12 md:py-20 lg:py-32 bg-[var(--white-warm)] relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-12 md:py-20 lg:py-32 bg-[var(--black)] text-white overflow-hidden relative", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-[var(--white-warm)] border-t border-gray-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group rounded-[32px] overflow-hidden aspect-[4/3] md:aspect-[21/9] lg:aspect-[21/9] shadow-soft cursor-pointer", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/installers", className: "absolute inset-0 z-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sr-only", children: "For Installers" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { src: "/images/stock/renoz-stacking.webp", alt: "Installers", className: "w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 p-8 md:p-12 flex flex-col items-start z-10 w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between w-full mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-3xl md:text-4xl font-bold text-white", children: "For Installers" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white/20 backdrop-blur-md p-2 rounded-full group-hover:bg-[var(--renoz-green)] transition-colors duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "text-white w-6 h-6" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[var(--text-muted)] text-lg max-w-md", children: "Partner with WA's OEM manufacturer." })
        ] })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 md:py-20 lg:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative z-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto mt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionSteps, { title: "Getting secure power is simple.", steps: [{
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 md:py-20 lg:py-32 xl:py-40 bg-[var(--cream)] relative overflow-hidden flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center relative z-10 max-w-4xl px-4", children: [

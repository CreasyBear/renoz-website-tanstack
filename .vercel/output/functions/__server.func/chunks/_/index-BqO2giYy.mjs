...
import { u as useScroll, b as useTransform, m as motion, B as Button, A as ArrowRight, l as SolarEconomics, I as Image, s as MapPin, S as Shield, Z as Zap, y as InverterMarquee, z as Star, n as MasonryGallery, o as getCaseStudySubset, L as Link, g as cn, k as AnimatePresence, a as createLucideIcon, d as Sun, C as ChevronDown } from "./router-DIqr-Eg3.mjs";
import { F as Flame } from "./flame-BRFPtM4T.mjs";
import { A as AccordionSteps } from "./AccordionSteps-D7DUWtLH.mjs";
...
import { Q as Quote } from "./quote-CKvK_Unz.mjs";
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[var(--cream)] font-sans selection:bg-[var(--renoz-green)] selection:text-white", ref: containerRef, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-[100svh] md:h-screen min-h-[600px] md:min-h-[800px] flex items-center overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full pt-20 md:pt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        opacity: 0,
        x: -50
      }, animate: {
        opacity: 1,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6 md:mb-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "heading-hero mb-6 md:mb-8 text-white leading-[0.95] tracking-tight", children: [
          "Like a ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
          ...
          delay: 0.2,
          ease: "easeOut"
        }, className: "glass-dark p-5 md:p-8 rounded-2xl mb-8 md:mb-12 max-w-xl border-l-4 border-[var(--renoz-green)] shadow-2xl backdrop-blur-xl bg-black/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg md:text-2xl text-zinc-100 font-normal leading-relaxed", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 sm:gap-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "primary", size: "lg", to: "/case-studies", className: "group text-lg px-8 rounded-full w-full sm:w-auto justify-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", size: "lg", to: "/contact", className: "text-lg px-8 rounded-full backdrop-blur-md bg-transparent border-white/30 text-white hover:bg-white hover:text-black transition-all w-full sm:w-auto justify-center", children: "Talk to an Expert" })
        ] })
      ] }) }) }),

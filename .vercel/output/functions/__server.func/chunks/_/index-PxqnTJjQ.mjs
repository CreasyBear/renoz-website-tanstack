...
import { u as useScroll, b as useTransform, m as motion, B as Button, A as ArrowRight, l as SolarEconomics, I as Image, s as MapPin, S as Shield, Z as Zap, y as InverterMarquee, z as Star, n as MasonryGallery, o as getCaseStudySubset, L as Link, g as cn, k as AnimatePresence, a as createLucideIcon, d as Sun, C as ChevronDown } from "./router-CNMZyROD.mjs";
import { F as Flame } from "./flame-BrlKITvk.mjs";
import { A as AccordionSteps } from "./AccordionSteps-BakYTDxJ.mjs";
...
import { Q as Quote } from "./quote-BK9X_jqP.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-screen min-h-[800px] flex items-center overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full pt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/60 text-sm font-medium tracking-wide", children: "Perth, Western Australia" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-3xl md:text-5xl lg:text-7xl xl:text-8xl font-bold mb-6 md:mb-8 text-white leading-[0.95] tracking-tight", children: [
          "Keep Your ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-transparent bg-clip-text bg-gradient-to-r from-[var(--renoz-green)] via-[var(--renoz-green-light)] to-white", children: "Power." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xl md:text-2xl mb-12 text-[var(--text-muted)] font-light leading-relaxed max-w-xl border-l-2 border-[var(--renoz-green)] pl-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-dark p-6 rounded-2xl min-w-[200px]", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[var(--text-secondary)] uppercase tracking-widest", children: "Energy Resilience" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-dark p-6 rounded-2xl min-w-[200px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-bold text-white mb-1", children: "10 Year" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[var(--text-secondary)] uppercase tracking-widest", children: "Replacement Warranty" })
        ] })
      ] })
    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-6 h-auto lg:h-[600px] mb-20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: "lg:col-span-8 h-[400px] lg:h-full relative rounded-[32px] overflow-hidden group shadow-soft", initial: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 p-8 md:p-12", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[var(--text-muted)] text-lg max-w-md leading-relaxed", children: "Western Australia demands resilience. Our systems are built to withstand dust, isolation, and extreme temperatures." })
          ] })
        ] }),

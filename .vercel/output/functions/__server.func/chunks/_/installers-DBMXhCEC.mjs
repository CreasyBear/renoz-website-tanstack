...
import { m as motion, I as Image, B as Button, T as TrendingUp, a as createLucideIcon, Z as Zap, A as ArrowRight } from "./router-CNMZyROD.mjs";
...
function InstallersPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[var(--cream)] font-sans", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-32 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-8 lg:gap-12", children: [{
        icon: TrendingUp,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-[1fr_1.5fr] gap-16 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight", children: [
            "Engineered for the ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400", children: "Trade Professional." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-lg mb-10 leading-relaxed", children: "We know you don't care about marketing fluff. You want specs that work, connections that don't strip, and protocols that talk to everything." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", children: [{
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gray-400 text-sm uppercase tracking-widest font-medium mb-2", children: spec.label }),

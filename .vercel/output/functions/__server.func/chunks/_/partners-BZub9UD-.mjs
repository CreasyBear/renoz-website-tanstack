...
import { m as motion, I as Image, c as createLucideIcon, B as Button, h as ArrowRight, L as Link, Z as Zap } from "./router-B12Uujuq.mjs";
...
function PartnersPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[var(--cream)] font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden bg-[var(--black)] text-white", children: [

...
import { m as motion, I as Image, a as createLucideIcon, B as Button, A as ArrowRight, L as Link, Z as Zap } from "./router-CAnbkd-m.mjs";
import { V as VerticalTimeline } from "./VerticalTimeline-nAp9cVOq.mjs";
import { H as HardHat } from "./hard-hat-iD-6vNUB.mjs";
...
const partnerTypes = [{
  icon: HardHat,
  title: "Installers",
  description: "Trade accounts, wholesale pricing, direct support, and leads from our 'Find an Installer' map.",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[var(--cream)] font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-[85vh] min-h-[600px] flex items-center justify-center overflow-hidden bg-[var(--black)] text-white", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: "absolute inset-0 z-0", initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[url('/images/utility/grid-pattern.png')] opacity-10" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-32 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      ...
      (() => {
        const steps = [{
          ...
          description: "Fill out the trade application. We verify your EC license and ABN to ensure we only sell to qualified professionals. Approval in < 24 hours.",
          image: "/images/stock/renoz-stacking.webp"
        }, {
          title: "Onboarding Session",
          description: "Visit our O'Connor facility. Meet the engineers, see the workshop, and get trained on our installation best practices.",
          image: "/images/about/unpacking-container.webp"
        }, {
          title: "Start Installing",
          description: "Access our wholesale portal. Order stock for local pickup or delivery. We pass leads to our network and support your installs.",
          image: "/images/case-studies/Harvey-35kWh.webp"
        }];
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden flex overflow-x-auto snap-x snap-mandatory gap-4 px-4 -mx-4 hide-scrollbar pb-8", children: steps.map((step, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "snap-center shrink-0 w-[85vw]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-50 rounded-2xl overflow-hidden shadow-sm h-full flex flex-col border border-gray-100", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-48 relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { src: step.image, alt: step.title, className: "w-full h-full object-cover", width: 400, height: 300 }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-4 left-4 bg-white/90 backdrop-blur px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider text-[var(--renoz-green)]", children: [
                "Step ",
                index + 1
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold mb-3 text-[var(--black)]", children: step.title }),

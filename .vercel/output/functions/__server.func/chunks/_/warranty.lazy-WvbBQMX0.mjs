...
import { f as createLazyFileRoute, m as motion, B as Button$1, g as Shield, c as createLucideIcon, A as AnimatePresence, h as ArrowRight, a as cn, S as Slot$2, C as ChevronDown, X, u as useComposedRefs, r as reactDomExports, d as buttonVariants, R as ReactDOM, s as supabase, e as createSlot$4, b as composeRefs } from "./router-CcuDqJxU.mjs";
...
import { C as CircleCheckBig } from "./circle-check-big-D7k_AsVz.mjs";
...
function AddressAutocomplete({
  ...
  const onAddressSelectRef = reactExports.useRef(onAddressSelect);
  reactExports.useEffect(() => {
...
async function uploadToSupabaseStorage(warrantyId, file) {
  try {
    ...
    const { error: uploadError } = await supabase.storage.from("warranty-uploads").upload(filePath, file, {
    ...
    const { data: urlData } = supabase.storage.from("warranty-uploads").getPublicUrl(filePath);
...
function FileUpload({
  ...
  // 25MB default (no more base64 bloat!)
      ...
      const performUpload = async (retryCount = 0) => {
        try {
          ...
          if (result.success && result.url) {
            onFilesChange((prevFiles) => {
              ...
              if (fileIndex !== -1) {
                updatedFiles[fileIndex] = {
                  ...
                  uploading: false,
                  originalFile: void 0
                  // Clear file reference after success
                };
              }
              return updatedFiles;
            });
            ...
            const isRetryableError = errorMessage.includes("network") || errorMessage.includes("server") || errorMessage.includes("timeout") || errorMessage.includes("fetch");
      ...
      !isOnline && /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-5 text-yellow-600", children: "⚠️" }),

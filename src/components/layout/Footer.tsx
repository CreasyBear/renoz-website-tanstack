      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between h-full">
            <div className="space-y-6">
              ...
              <p className="text-gray-500 text-sm leading-relaxed max-w-xs">
                Building Western Australia's battery capability for a resilient, renewable future.
              </p>
            </div>
          ...
          <div className="lg:col-span-2">
            <h4 className="font-bold text-xs uppercase tracking-widest text-gray-600 mb-6">Product</h4>
          ...
          <div className="lg:col-span-2">
            <h4 className="font-bold text-xs uppercase tracking-widest text-gray-600 mb-6">Company</h4>
            <ul className="space-y-3">
              {[
          ...
          <div className="lg:col-span-4">
             ...
             <ul className="space-y-4">
               <li>
                 <a href="mailto:sales@renoz.energy" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors group">
                   <Mail size={16} className="text-[var(--renoz-green)] group-hover:text-white transition-colors" />
                   <span className="text-sm">sales@renoz.energy</span>
                 </a>
               </li>
               <li>
                 <a href="tel:1800736693" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors group">
                   <Phone size={16} className="text-[var(--renoz-green)] group-hover:text-white transition-colors" />
                   <span className="text-sm">1800 736 693</span>
                 </a>
               </li>
               <li className="flex items-start gap-3 text-gray-400 group">
                 <MapPin size={16} className="text-[var(--renoz-green)] mt-0.5 shrink-0" />
                 <span className="text-sm leading-relaxed text-gray-500">
                   Unit 4, 8 Murphy Street<br/>O'Connor WA 6163
                 </span>
               </li>
             </ul>
             ...
             <div className="mt-8 pt-8 border-t border-white/10">
               ...
               >
                 <span className="text-sm font-bold">Register Your Warranty</span>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2 text-xs text-gray-600">
             ...
             <span className="hidden md:inline">Engineered in Western Australia</span>
          </div>

		...
		>
			<div className="flex gap-4 p-4">
				<button
					...
					className="px-4 py-2 bg-[var(--renoz-green-ink)] text-white rounded-md hover:bg-[var(--renoz-green-dark)] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
				>

	...
	return (
		<section className="py-24 bg-[var(--black)] text-white relative overflow-hidden">
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				...
				<div className="md:hidden flex overflow-x-auto snap-x snap-mandatory gap-4 px-4 -mx-4 hide-scrollbar pb-8">
					<div className="snap-center shrink-0 w-[85vw] h-[450px]">
						...
						>
							...
							<div className="relative z-10 p-8 flex flex-col justify-between h-full text-left">
								<div>
						...
						>
							...
							<div className="relative z-10 p-8 flex flex-col justify-between h-full text-white text-left">
								<div>
									...
									<div className="flex items-baseline gap-2">
										<h3 className="text-6xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white to-gray-400 drop-shadow-2xl">
											30c
										</h3>
								...
								<div className="pt-8 border-t border-white/10">
									...
									<p className="text-sm text-gray-300 mt-2 leading-relaxed">
										When the sun sets, you pay peak rates for the electricity
										you generated hours ago.
									</p>
								</div>
							</div>
						</motion.div>
				...
				{/* Desktop: Grid */}
				<div className="hidden md:grid md:grid-cols-2 gap-4 md:gap-8 max-w-5xl mx-auto">
					{/* Day Side */}
					<motion.div
						initial={{ opacity: 0, x: -20 }}
						whileInView={{ opacity: 1, x: 0 }}

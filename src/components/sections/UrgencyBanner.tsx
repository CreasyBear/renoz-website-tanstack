                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-700 leading-relaxed max-w-xl mb-8">
                            Every single day this summer, your panels are generating peak power.
                            Without a battery, that value is evaporating.
                            <br /><br />
                        ...
                        <p className="text-xs text-gray-500 mt-4">*Based on 10kW system exporting 40kWh/day at 5c vs offsetting 30c usage.</p>
                    </motion.div>
                    ...
                    >
                         <div className="absolute inset-0 bg-white rounded-[40px] shadow-2xl overflow-hidden border border-white/50">
                            ...
                            <div className="p-8 h-full flex flex-col justify-between bg-gradient-to-b from-white to-orange-50/50">
                                <div>
                                    <h3 className="text-gray-900 font-bold text-2xl mb-2">Summer Savings</h3>
                                ...
                                <div className="space-y-4">
                                     <div className="flex items-center justify-between p-4 rounded-2xl bg-white shadow-sm border border-gray-100">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="font-bold text-gray-900">Stored Energy</div>
                                                <div className="text-xs text-gray-500">Self-consumption</div>
                                            </div>
                                        </div>
                                        <div className="font-bold text-green-600 text-xl">+$2,100</div>
                                     </div>
                                     ...
                                     <div className="flex items-center justify-between p-4 rounded-2xl bg-white shadow-sm border border-gray-100 opacity-50 grayscale">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="font-bold text-gray-900">Grid Exports</div>
                                                <div className="text-xs text-gray-500">Feed-in Tariff (5c)</div>
                                            </div>
                                        </div>
                                ...
                                <div className="pt-6 border-t border-gray-100">
                                    <div className="flex justify-between items-end">
                                        <div className="text-sm font-medium text-gray-500">Missed Opportunity</div>

...
import { Sun, Moon, Home, Zap, Battery, DollarSign, TrendingUp } from 'lucide-react';
    ...
    <div className="relative w-full aspect-[4/3] bg-gradient-to-br from-gray-900 to-gray-800 rounded-[40px] overflow-hidden p-8 flex flex-col justify-between">
      ...
      <div className="relative z-10 flex justify-between items-start">
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/10">
          <div className="text-gray-400 text-xs font-bold uppercase tracking-wider mb-1">Grid Reality</div>
        ...
        <div className="w-full max-w-lg grid grid-cols-3 gap-4 items-center relative">
            ...
            <div className="flex flex-col items-center text-center z-10">
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 border border-white/10 w-full">
                    ...
                    <div className="text-white font-bold text-xl">5c<span className="text-xs font-normal text-gray-400">/kWh</span></div>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center text-center z-10 pt-12">
                ...
                <div className="text-gray-400 text-xs font-bold uppercase tracking-wider">The Grid</div>
                <div className="mt-2 text-red-400 text-xs font-bold bg-red-500/10 px-2 py-1 rounded">Markup: 600%</div>
            </div>
            ...
            <div className="flex flex-col items-center text-center z-10">
                <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mb-4 shadow-lg ring-4 ring-blue-500/20">
                 ...
                 <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 border border-white/10 w-full">
                    ...
                    <div className="text-white font-bold text-xl">30c<span className="text-xs font-normal text-gray-400">/kWh</span></div>
                </div>
            </div>
        </div>
      </div>
      ...
      <div className="relative z-10 bg-[var(--renoz-green)]/10 border border-[var(--renoz-green)]/20 rounded-2xl p-4 flex items-center gap-4">
        ...
        <div>
            <div className="text-[var(--renoz-green)] font-bold text-sm">The RENOZ Fix</div>
            <div className="text-white/80 text-xs">Store your 5c power. Use it when it's worth 30c.</div>
        </div>
      </div>
    </div>
  );

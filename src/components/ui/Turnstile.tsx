...
export default function Turnstile({
  ...
  }, [isLoaded, siteKey, onVerify, onError, onExpire, theme, size, isDisabled])

  if (isDisabled) {
    return (
      <div className={`p-4 bg-yellow-100 text-yellow-800 text-sm rounded border border-yellow-200 ${className}`}>

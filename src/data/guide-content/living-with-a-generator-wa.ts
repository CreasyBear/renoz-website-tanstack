...
export const guide: Guide = {
	...
	sections: [
		...
		},
		{
			...
			body: [
				"Fuel logistics scale with runtime. The per-litre, per-hour and per-day figures for your genset class are worked in [our generator cost guide](/guides/generator-running-costs-wa), which also points to [FuelWatch](https://www.fuelwatch.wa.gov.au) for your town's notified price. The logistics, though, are yours: a household running its genset through winter means drums on the ute every fortnight if the nearest bowser is a town trip away. Cartage, spillage, and stale fuel come with that.",
				"Servicing runs on engine hours. [Our generator cost guide](/guides/generator-running-costs-wa) shows how the service interval converts into real money for a machine that runs every day; twice-yearly servicing is fine for a weekender genset with 30 hours on the clock, but a daily runner pays for it as a genuine cost line, on top of the fuel.",

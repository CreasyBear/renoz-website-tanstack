	...
	sections: [
		{
			...
			body: [
				...
				"A power bill is not a complete off-grid design brief. It can hide daytime solar self-consumption, motor starts, seasonal occupancy, future electrification, and the difference between an average day and the worst ordinary sequence. A useful brief combines interval data where available with an appliance and operating diary. The sizing arithmetic itself, the daily kWh audit, autonomy days by WA climate zone, and depth of discharge, is worked through in the [battery sizing guide for off-grid WA](/guides/battery-sizing-off-grid-wa); this page covers the design decisions those numbers feed.",
			],
		},
		{

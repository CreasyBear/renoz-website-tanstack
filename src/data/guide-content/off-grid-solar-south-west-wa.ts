	...
	sections: [
		...
		},
		{
			...
			body: [
				...
				"RENOZ LV modules are 5.12 kWh each (LV-5KWH100AH), and a tower holds up to 8 modules — approximately 41 kWh of installed capacity. Most South West off-grid homes land between 10 and 30 kWh of usable storage depending on load profile and target autonomy days. Up to 6 towers can be paralleled for larger sites. The modular format means you can commission a base system and add capacity later as loads grow — a bore pump addition, a workshop, or an EV charger — without replacing the battery bank.",
		...
		},
		{
			...
			body: [
				"RENOZ manufactures LiFePO4 battery modules at O'Connor in Perth — not a distributor importing batteries designed for other markets. For South West buyers, this matters on two practical fronts: warranty service can be fulfilled from Perth rather than through an offshore returns chain, and the battery design is informed by WA operating conditions including the heat cycles of inland summer blocks and the sustained moderate temperatures of the South West coastal strip.",

	...
	sections: [
		{
			...
			body: [
				...
				"Around that spike sits a flat, unforgiving base load: the **cold room** compressor cycles day and night because product temperature is a food-safety and shelf-life parameter, not a comfort preference. Pulp-temperature and shelf-life requirements mean refrigeration does not pause for the weekend or a cloudy week. This is why cold room solar power sizing starts with two numbers from interval data, the pack-run peak and the overnight refrigeration base, and not with an annual kWh figure.",
				"A 15-minute interval dataset from your meter or inverter is the whole sizing input. Consider a season where the pack run peaks at 60 kW for three hours each morning while the rooms hold 15 kW overnight: the battery is sized for the overnight base plus bridge autonomy, the PV array is sized for the daily energy plus recharge, and the inverter is sized for the motor starting case. Each number comes from a different constraint, which is why single-figure quotes are a red flag.",

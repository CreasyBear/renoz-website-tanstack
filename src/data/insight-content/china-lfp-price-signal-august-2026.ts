	...
	blocks: [
		{
			kind: "prose",
			paragraphs: [
				"The information in Mariana Lithium’s 12 August WeChat bulletin is in the cross-section, not in any single average. Storage-grade LFP — the iron-phosphate cathode powder specified for energy-storage cells — averaged 57,000 CNY/t, about A$12,000/t, up 1,000 CNY on the day and 5.56% over seven days. Power-grade LFP, the higher-rate cousin, averaged 58,000 CNY/t (about A$12,200/t), up 5.45%. A 5–6% week in a cathode powder is a move. It is not, by itself, a market index: the bulletin does not say how the high, low and average are sampled.",
				"Refined lithium moved with it. Battery-grade lithium carbonate (99.5%) averaged 147,000 CNY/t, about A$30,900/t, up 5.00% over seven days. Battery-grade lithium hydroxide, the salt high-nickel cathode prefers, was up about 6%. Six-percent spodumene concentrate CIF China, the mine-gate product Western Australia actually ships, rose 0.98% to US$2,070/t. Hydroxide and carbonate are the chemicals. Spodumene is the rock. This print is tight in the chemicals and in LFP powder. It is not tight at the mine gate.",
				"This briefing keeps those lines, converts the yuan at a late-August 2026 mid-market rate so the scale is readable in Australian dollars, and stops before the averages are treated as an executable offer or as an installed-system price in Western Australia.",
			],
		},
		...
		spotTable,
		{
			...
			paragraphs: [
				"This bulletin is a one-day China spot print. The SDIC Securities note published the same day is a 2026 supply–demand forecast for lithium carbonate, with a quoted shortfall and an internal discrepancy on storage demand. A tight 2026 balance sheet does not, on its own, explain a one-week cathode move, and a one-week cathode move does not prove the 2026 shortfall.",
			],
		},
		{ kind: "sources" },
	],

...
const putailaiTable: InsightTableBlock = {
	...
	note: `The two separator phases are one 7.2 billion m² plan, ${audFromCny(5.6e9)} (CNY 5.6 billion) in total. Putailai (603659.SH) makes anode materials and separator film — midstream products, not cells. Twenty-Four Tide flags it as the named exception to 2025 self-discipline.`,
};

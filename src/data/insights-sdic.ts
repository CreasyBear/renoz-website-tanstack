...
export const sdicForecastTables: SdicForecastTable[] = [
	...
	{
		title: "Table 11: Glass-ceramics, lubricating-grease, and other-sector lithium consumption forecast",
	...
	{
		title: "Table 12: China lithium-carbonate supply-demand balance and forecast",
		unit: "Physical tonnes",
		publisher: SDIC_PUBLISHER,
		sourceUrl: SDIC_SOURCE_URL,
		columns: ["", "2023", "2024", "2025", "2026E", "2030E", "2035E"],
		rows: [
			{ label: "Production", cells: ["460095", "675744", "970425", "1393781", "—", "—"] },
			{ label: "Imports", cells: ["158748", "234722", "242969", "336022", "—", "—"] },
			{ label: "Exports", cells: ["(9592)", "(3829)", "(5290)", "(4985)", "—", "—"] },
			{ label: "Total supply", cells: ["609251", "906637", "1208104", "1724818", "—", "—"] },
			{ label: "Total demand", cells: ["585762", "845780", "1229684", "1771600", "2348700", "2871100"] },
			{ label: "YoY and CAGR", cells: ["—", "44.39%", "45.39%", "44.07%", "7.30%", "4.10%"] },
			{ label: "Supply-demand balance", cells: ["23487", "61149", "(21581)", "(46782)", "—", "—"] },
		],
		sourceNote:

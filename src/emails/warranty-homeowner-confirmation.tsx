			...
			<Section style={styles.mainSection}>
				...
				<Section style={styles.heroSection}>
					...
					<Text style={styles.heroText}>
						Hi {homeownerName}, your new RENOZ energy storage system is
				...
				<Section style={styles.contentSection}>
					...
					<Section style={styles.ctaBox}>
						...
						<Text style={styles.ctaText}>
							Access user manuals, safety guides, and tips for maintaining your
							battery health in our resource center.
						</Text>
				...
				<Section style={styles.footerSection}>
					<Text style={styles.footerText}>
						Please keep this email for your records. If you ever need support,

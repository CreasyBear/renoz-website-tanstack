		...
		<EmailLayout preview={`Registration Received - ${warrantyId}`}>
			<Section style={styles.mainSection}>
				...
				<Section style={styles.section}>
					<Heading
						as="h3"
						style={{ ...styles.sectionHeading, borderColor: "#10b981" }}
					>
						👷 Installer Record
					</Heading>
				...
				<Section style={styles.stepsSection}>
					<Heading as="h4" style={styles.stepsHeading}>
						What happens next?
					</Heading>
					<Row style={styles.stepRow}>
						...
						<Column>
							<Text style={styles.stepText}>
								<strong>Review:</strong> Our engineering team verifies the
								installation details (24-48 hrs).
							</Text>
						</Column>
					</Row>
					<Row style={styles.stepRow}>
						...
						<Column>
							<Text style={styles.stepText}>
								<strong>Activation:</strong> Once approved, the 10-year warranty
					...
					<Row>
						...
						<Column>
							<Text style={styles.stepText}>
								<strong>Certificate:</strong> We'll email the official warranty
								certificate to you.
							</Text>
						</Column>
					</Row>

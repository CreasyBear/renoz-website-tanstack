...
export const WarrantySupportEmail = ({
	payload,
}: WarrantySupportEmailProps) => {
	const p = payload || {};
			...
			<Section style={styles.mainSection}>
				...
				<Section style={styles.contentSection}>
					...
					<DataRow
						label="Email"
						value={
							<Link href={`mailto:${p.installer?.email}`} style={styles.link}>
								{p.installer?.email}
							</Link>
						}
					/>
				...
				<Section style={styles.contentSection}>
					...
					<DataRow
						...
						value={
							<Link href={`mailto:${p.customer?.email}`} style={styles.link}>
								{p.customer?.email}
							</Link>
						}
					/>
				...
				<Section style={styles.contentSection}>
					...
					<DataRow
						label="Inverter"
						value={
							`${p.system?.inverter?.brand || ""} ${p.system?.inverter?.model || ""}`.trim() ||
							"Not Specified"
						}
					/>
				</Section>
				...
				<Section style={styles.contentSection}>
					...
					<Container style={styles.storageContainer}>
						<Text style={styles.storageText}>
							<strong>Supabase Bucket:</strong>{" "}
							<span style={styles.storageValue}>warranty-uploads</span>
						</Text>
						<Text style={{ ...styles.storageText, marginBottom: 0 }}>
							<strong>Folder Path:</strong>{" "}
							<span style={styles.storageValue}>
								warranty-files/{p.warrantyId}
							</span>
						</Text>
						<Text style={styles.storageHint}>
							💡 All files for this warranty are organized in the above folder
				...
				<Section style={styles.footerSection}>
					<Text style={styles.footerText}>
						📧 <strong>Email Recipients:</strong> Support team, installer, and
						homeowner (if applicable) have all received copies of this warranty
						registration.
					</Text>
					<Text style={styles.footerText}>
						🔍 For warranty terms and your Australian Consumer Law rights, visit{" "}
						<Link href="https://renoz.energy/resources" style={styles.link}>
							renoz.energy/resources
						</Link>
						.
					</Text>
					<Text style={{ ...styles.footerText, marginBottom: 0 }}>
						🛠️ <strong>For Support Team:</strong> Access files via direct links
						above or through the Supabase Storage dashboard.
					</Text>
				</Section>
			</Section>
		</EmailLayout>

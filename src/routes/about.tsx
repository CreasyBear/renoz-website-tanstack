...
import { Check, Award, Users, Shield, X, Quote, Atom, Thermometer, Truck, Zap, Handshake } from 'lucide-react'
...
export const Route = createFileRoute('/about')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Perth-based OEM manufacturer building Western Australia\'s battery capability. Learn about our mission, team, and commitment to local manufacturing.' },
      { property: 'og:title', content: 'About RENOZ Energy - Perth Battery Manufacturer' },
      { property: 'og:description', content: 'Perth-based OEM manufacturer building Western Australia\'s battery capability. Learn about our mission, team, and commitment to local manufacturing.' },
      { property: 'og:url', content: `${baseUrl}/about` },
      { name: 'twitter:title', content: 'About RENOZ Energy - Perth Battery Manufacturer' },
      { name: 'twitter:description', content: 'Perth-based OEM manufacturer building Western Australia\'s battery capability.' },
    ],
  }),
  component: AboutPage,
})
...
function AboutPage() {
  ...
  const partners = [
    { name: 'Brill Power', logo: '/images/partners/brill-power-logo.svg', width: 140 },
    { name: 'CE+T Power', logo: '/images/partners/CE+T Logo.png', width: 120 },
    { name: 'CDI Energy', logo: '/images/partners/CDI Energy Logo.png', width: 130 },
    { name: 'Battery Works', logo: '/images/partners/BatteryWorks.png', width: 140 },
  ]
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full pt-10">
          ...
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight">
              Perth's Own <br/>
              <span className="text-[var(--renoz-green)]">Battery Manufacturer</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <span className="text-[var(--renoz-green)] font-bold tracking-widest uppercase text-xs mb-4 block">Our Origins</span>
              ...
              <div className="space-y-6 text-lg text-[var(--text-muted)] leading-relaxed">
                <p>
                  CEO Simon Chan has spent over 11 years developing Lithium-Ion Batteries for Australia, co-founding two successful Australian battery companies. Working alongside Shandong Huison Electronics, Simon also developed off-grid energy solutions for the Amish community in Cleveland, Ohio—people who live without grid connection by choice.
                </p>
                <p>
                  He saw striking parallels with Western Australia: remote communities, unreliable grid infrastructure, and a climate that punishes standard equipment. The technology that worked for the Amish could transform energy independence in WA.
                </p>
                <p>
                  In 2024, RENOZ Energy was born—bringing proven, rugged technology to Australian homes, farms, and businesses.
                </p>
              </div>
            </motion.div>
      ...
      <section className="py-24 bg-[var(--cream)] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-[var(--text-muted)]">The principles that guide every system we build.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8 mb-24">
            {[
              { icon: Shield, title: "Resilience", desc: "We engineer for the worst-case scenario, so your power stays on when it matters most." },
              { icon: Users, title: "Local Support", desc: "No call centers overseas. You speak to the engineers who built your system." },
              { icon: Award, title: "Quality", desc: "We use only tier-1 components and rigorously test every unit before it leaves our Perth facility." }
            ].map((item, i) => (
              <Card key={i} className="bg-white border-none shadow-soft hover:shadow-lg transition-all" hover>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <span className="text-[var(--renoz-green)] font-bold tracking-widest uppercase text-xs mb-4 block">Technology Philosophy</span>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                Chemistry Agnostic.<br/>
                <span className="text-gray-400">Future Ready.</span>
              </h2>
              <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
                <p>
                  Battery chemistry is evolving rapidly. Rather than lock into a single technology, we've designed our systems to work with multiple chemistries—LFP today, Sodium-ion tomorrow, and whatever comes next.
                </p>
                <p>
                  Our partnership with Brill Power enables "Software Defined Batteries" that optimise performance regardless of cell chemistry, giving you a system that won't become obsolete.
                </p>
              </div>
            </motion.div>
      ...
      <section className="py-20 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h3 className="text-3xl font-bold text-[var(--black)] mb-4">Ecosystem of Trust</h3>
            <p className="text-[var(--text-muted)] text-lg">Partnering with global leaders. Certified for local standards.</p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div>
              <div className="flex items-center gap-3 mb-8">
                ...
                <h4 className="text-xl font-bold">Certifications & Memberships</h4>
              </div>
              ...
              />
                ...
                {[
                      { text: 'Smart Energy Council Member', sub: 'Gold Member Since 2025' },
                      { text: 'UL1973 Certified', sub: 'Safety for Stationary Batteries' },
                      { text: 'Clean Energy Council Approved', sub: 'Eligible for Rebates' },
                      { text: 'AS/NZS 5139 Compliant', sub: 'Australian Installation Standard' }
                    ].map((item, i) => (
                      <li key={i} className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="font-bold text-[var(--black)] text-sm">{item.text}</div>
              ...
              >
                <div className="relative mb-6 rounded-[24px] overflow-hidden aspect-square mx-auto shadow-md group-hover:shadow-xl transition-all duration-300 transform group-hover:-translate-y-2 bg-gray-200">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4">
                    <span className="text-white text-xs font-bold tracking-widest uppercase">Read Bio</span>
                  </div>
                </div>
                <h3 className="font-bold text-lg text-[var(--black)]">{member.name}</h3>
                <p className="text-sm text-[var(--renoz-green)] font-medium uppercase tracking-wide mt-1">{member.role}</p>
              </motion.div>
              ))}
          </div>
        </div>
            ...
            >
              ...
              <div className="w-full md:w-2/5 relative min-h-[250px] md:min-h-full">
                ...
                <div className="absolute bottom-6 left-6 text-white md:hidden">
                  ...
                  <p className="text-[var(--renoz-green)] font-bold">{selectedMember.role}</p>
                </div>
              </div>

              <div className="w-full md:w-3/5 p-8 md:p-12 flex flex-col justify-center bg-white">
                <div className="hidden md:block mb-6">
                  <h3 className="text-3xl font-bold text-[var(--black)] mb-2">{selectedMember.name}</h3>
                  <p className="text-[var(--renoz-green)] font-bold uppercase tracking-wider">{selectedMember.role}</p>
                </div>

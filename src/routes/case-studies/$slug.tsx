...
import { MapPin, Zap, CheckCircle2, ArrowLeft } from 'lucide-react'
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8">
            <div className="prose prose-lg max-w-none text-[var(--text-muted)]">
              <h2 className="text-3xl font-bold text-[var(--black)] mb-6">Overview</h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div className="bg-red-50 p-8 rounded-2xl border border-red-100">
                  <h3 className="text-xl font-bold text-red-900 mb-4">The Challenge</h3>
              ...
              <h2 className="text-3xl font-bold text-[var(--black)] mb-6">Outcome</h2>
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="bg-[var(--black)] text-white p-8 rounded-[24px]">
              ...
              <p className="text-gray-400 mb-6">
                Our engineering team can design a system to meet your specific requirements.
              </p>
              <Button variant="primary" to="/contact" className="w-full justify-center">
                Get a Quote
              </Button>
            </div>
          </div>

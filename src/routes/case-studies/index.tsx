...
export const Route = createFileRoute('/case-studies/')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Real results from real installations across Western Australia. See how RENOZ battery systems are powering homes, farms, and businesses.' },
      { property: 'og:title', content: 'Case Studies - RENOZ Energy' },
      { property: 'og:description', content: 'Real results from real installations across Western Australia. See how RENOZ battery systems are powering homes, farms, and businesses.' },
      { property: 'og:url', content: `${baseUrl}/case-studies` },
      { name: 'twitter:title', content: 'Case Studies - RENOZ Energy' },
      { name: 'twitter:description', content: 'Real results from real installations across Western Australia.' },
    ],
  }),
    ...
    <div className="min-h-screen bg-[var(--white)]">
      ...
      <section className="bg-[var(--black)] text-white pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <span className="text-[var(--renoz-green)] font-bold tracking-widest uppercase text-xs mb-4 block">Provenance</span>
            <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">
              Real Results.
            </h1>
            <p className="text-xl text-gray-400 leading-relaxed">
              From the Wheatbelt to the Perth Hills, see how RENOZ systems are powering Western Australia.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[var(--renoz-green)] font-bold tracking-widest uppercase text-xs mb-4 block">Featured Stories</span>
            <h2 className="text-4xl font-bold text-[var(--black)]">In-Depth Case Studies</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {caseStudies.map((study, index) => (
              ...
              >
                <Link to={`/case-studies/${study.slug}`} className="block h-full group">
      ...
      <section className="py-24 bg-[var(--cream)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[var(--renoz-green)] font-bold tracking-widest uppercase text-xs mb-4 block">Our Work</span>
            <h2 className="text-4xl font-bold text-[var(--black)] mb-4">Installation Gallery</h2>
            <p className="text-[var(--text-muted)] text-lg max-w-2xl mx-auto">
              Every system we install is built to last. Browse real installations across Western Australia.
            </p>
          </div>
          <MasonryGallery
            showRating={true}
      ...
      <section className="py-24 bg-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <Button variant="primary" size="lg" to="/contact" className="rounded-full">
            Talk to an Engineer
          </Button>
        </div>
      </section>

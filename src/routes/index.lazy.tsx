		...
		>
			...
			<section className="relative h-[100svh] md:h-screen min-h-[600px] md:min-h-[800px] flex items-center overflow-hidden">
				...
				<motion.div className="absolute inset-0 z-0">
					...
					>
						<img
							src="/images/about/perth-skyline-kingspark-stylized.webp"
							alt=""
				...
				<div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full pt-20 md:pt-24">
					<div className="grid lg:grid-cols-2 gap-12 items-center">
						<div className="max-w-3xl">
							...
							<div className="hidden md:block glass-dark p-6 md:p-8 rounded-2xl mb-8 md:mb-12 max-w-lg border-l-4 border-[var(--renoz-green)] shadow-2xl">
			...
			<section className="section-spacing px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative z-20">
				...
				<div className="border-t border-gray-100 pt-12">
					<p className="text-center text-sm font-bold text-[var(--text-muted)] uppercase tracking-widest mb-8">

...
import { PhoneCall, HardHat, Warehouse, TrendingUp, Zap, ShieldCheck, CheckCircle2, ArrowRight } from 'lucide-react'
...
export const Route = createFileRoute('/installers')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Join WA\'s leading battery manufacturer network. Local stock, direct engineer support, and competitive wholesale pricing for certified installers.' },
      { property: 'og:title', content: 'Installer Partnership - RENOZ Energy' },
      { property: 'og:description', content: 'Join WA\'s leading battery manufacturer network. Local stock, direct engineer support, and competitive wholesale pricing.' },
      { property: 'og:url', content: `${baseUrl}/installers` },
      { name: 'twitter:title', content: 'Installer Partnership - RENOZ Energy' },
      { name: 'twitter:description', content: 'Join WA\'s leading battery manufacturer network. Local stock, direct engineer support, and competitive wholesale pricing.' },
    ],
  }),
    ...
    <div className="min-h-screen bg-[var(--cream)] font-sans">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-12 leading-relaxed max-w-2xl mx-auto font-light">
              We cut out the distributor to give you better margins, direct access to stock, and engineering support that actually picks up the phone.
            </p>

            <div className="flex flex-col sm:flex-row gap-5 w-full justify-center">
               <Button variant="primary" size="lg" to="/contact?type=installer" className="rounded-full px-10 py-7 text-lg shadow-xl hover:shadow-[var(--renoz-green)]/20 transition-all">
                 Apply for Trade Account
               </Button>
               <Button variant="outline" size="lg" to="/products/residential" className="rounded-full px-10 py-7 text-lg text-white border-white/20 hover:bg-white hover:text-[var(--black)] backdrop-blur-sm">
                 View Product Range
               </Button>
            </div>
          </motion.div>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold mb-4 text-[var(--black)]">The RENOZ Difference.</h2>
            <p className="text-[var(--text-muted)] text-xl">Why WA sparkies are making the switch.</p>
          </div>
      ...
      <section className="py-32 bg-[var(--black)] text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-[1fr_1.5fr] gap-16 items-center">
            <div>
              <div className="text-[var(--renoz-green)] font-bold tracking-widest uppercase mb-4">Technical Superiority</div>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                Engineered for the <br/>
                <span className="text-gray-400">Trade Professional.</span>
              </h2>
              <p className="text-gray-400 text-lg mb-10 leading-relaxed">
                We know you don't care about marketing fluff. You want specs that work, connections that don't strip, and protocols that talk to everything.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { label: "Nominal Voltage", value: "51.2V", sub: "16S Architecture" },
                ...
                >
                  <div className="text-gray-400 text-sm uppercase tracking-widest font-medium mb-2">{spec.label}</div>
                  <div className="text-4xl font-bold text-white mb-1">{spec.value}</div>
                  <div className="text-[var(--renoz-green)] text-sm font-mono">{spec.sub}</div>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <AccordionSteps
              ...
              steps={[
                ...
                {
                  title: "Get Onboarded",
                  content: "We'll send you our wholesale price list and invite you to the O'Connor facility. Come have a coffee, meet the engineers, and see the assembly line.",
          ...
          <div className="bg-[var(--black)] rounded-[40px] p-8 md:p-16 text-white overflow-hidden relative">
            <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-4xl md:text-5xl font-bold mb-6">Commercial & HV Systems.</h2>
                <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                  From residential retrofits to megawatt-scale commercial projects, we have the hardware and the engineering chops to back you up.
                  Access our commercial range (50kWh - 2MWh) for your larger clients.
                </p>
                <Button variant="primary" size="lg" to="/products/commercial" className="rounded-full px-8 py-4">
      ...
      <section className="py-32 text-center bg-[var(--cream)]">
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-bold mb-8 text-[var(--black)]">Ready to switch?</h2>
          <p className="text-[var(--text-muted)] mb-10 text-xl">
            Join the network of WA installers who are backing local engineering.
          </p>
          <div className="flex justify-center">
             <Button variant="primary" size="lg" to="/contact?type=installer" className="rounded-full px-16 py-6 text-xl shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1">
               Apply for Trade Account
             </Button>
          </div>
        </div>

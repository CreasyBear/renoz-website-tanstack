...
export function ProductsPage() {
	// TanStack Router: Access validated search params for filtering/sorting
	// const search = useSearch({ from: "/products/" });

	// Example usage of search params for filtering
	// const filteredProducts = products.filter(product => {
	// 	if (search.category && !product.name.toLowerCase().includes(search.category.toLowerCase())) {
	// 		return false;
	// 	}
	// 	if (search.type && product.type !== search.type) {
	// 		return false;
	// 	}
	// 	return true;
	// });

...
import { Home, Tractor, Building, Check, ArrowRight, Shield, Zap, Battery, Boxes, Settings2 } from 'lucide-react'
...
export const Route = createFileRoute('/products/')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Residential, rural, and commercial battery energy storage systems. From 10kWh home systems to multi-megawatt industrial solutions.' },
      { property: 'og:title', content: 'Battery Systems - RENOZ Energy' },
      { property: 'og:description', content: 'Residential, rural, and commercial battery energy storage systems. From 10kWh home systems to multi-megawatt industrial solutions.' },
      { property: 'og:url', content: `${baseUrl}/products` },
      { name: 'twitter:title', content: 'Battery Systems - RENOZ Energy' },
      { name: 'twitter:description', content: 'Residential, rural, and commercial battery energy storage systems. From 10kWh home systems to multi-megawatt industrial solutions.' },
    ],
  }),
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-[var(--text-muted)] max-w-2xl mx-auto leading-relaxed">
              From compact residential units to megawatt-scale industrial power plants.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="p-12 lg:p-20 flex flex-col justify-center order-2 lg:order-1">
                ...
                <h2 className="text-4xl font-bold text-[var(--black)] mb-4">Residential Series</h2>
                <div className="text-2xl font-bold text-[var(--renoz-green)] mb-6">10 - 50 kWh</div>
                <p className="text-lg text-[var(--text-muted)] mb-8 leading-relaxed">
                  Genuine security for your home. Our residential systems are designed to power your entire household, not just the essentials, keeping your lights on and air conditioning running during blackouts.
                </p>

                <ul className="space-y-4 mb-10">
                  {['Full home backup capability', 'Silent operation', 'App-based monitoring', '10-year warranty'].map((item, i) => (
                ...
                <Button variant="primary" to="/products/residential" className="self-start">
                  View Specifications
                </Button>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="p-12 lg:p-20 flex flex-col justify-center">
                ...
                <h2 className="text-4xl font-bold text-white mb-4">Rural Series</h2>
                <div className="text-2xl font-bold text-[var(--renoz-green)] mb-6">50 - 200 kWh</div>
                <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                  True energy independence. A rugged, silent alternative to diesel generators for properties at the edge of the grid. Built to withstand heat, dust, and isolation.
                </p>
                ...
                <div className="grid grid-cols-2 gap-6 mb-10">
                  <div className="bg-white/5 p-4 rounded-xl border border-white/10">
                    ...
                    <div className="text-sm text-gray-400">Dust & Water Proof</div>
                  </div>
                  <div className="bg-white/5 p-4 rounded-xl border border-white/10">
                    <Zap className="w-6 h-6 text-[var(--renoz-green)] mb-2" />
                    <div className="font-bold">3-Phase</div>
                    <div className="text-sm text-gray-400">High Output Power</div>
                  </div>
                </div>

                <Button variant="outline" to="/products/rural" className="self-start border-white text-white hover:bg-white hover:text-black">
                  View Specifications
                </Button>
              </div>
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="p-12 lg:p-20 flex flex-col justify-center order-2 lg:order-1">
                ...
                <h2 className="text-4xl font-bold text-[var(--black)] mb-4">Commercial Series</h2>
                <div className="text-2xl font-bold text-[var(--renoz-green)] mb-6">200+ kWh</div>
                <p className="text-lg text-[var(--text-muted)] mb-8 leading-relaxed">
                  Total control over your energy costs. Turn energy into a managed asset, stabilise operational costs, and secure your business against grid outages.
                </p>

                <ul className="space-y-4 mb-10">
                  {['Peak shaving capability', 'Grid support services', 'Modular scalability', 'Remote fleet management'].map((item, i) => (
                    <li key={i} className="flex items-center gap-3">
                      <div className="w-6 h-6 rounded-full bg-[var(--renoz-green)]/10 flex items-center justify-center">
                        <Check className="w-3 h-3 text-[var(--renoz-green)]" />
                      </div>
                ...
                <Button variant="primary" to="/products/commercial" className="self-start">
                  View Specifications
                </Button>
              </div>
              <div className="relative h-[400px] lg:h-auto bg-gray-100 order-1 lg:order-2">
      ...
      <section className="py-24 bg-[var(--white-warm)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="text-center mb-16">
            ...
            <p className="text-[var(--text-muted)]">Select the system that fits your project scale.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-[var(--text-muted)] mb-8 text-sm h-12">For homes and small businesses needing backup & self-consumption.</p>

              <div className="space-y-4 mb-8 flex-1">
                 <div className="flex justify-between items-center text-sm border-b border-gray-50 pb-2">
                   <span className="text-gray-400 flex items-center gap-2"><Battery className="w-4 h-4"/> Capacity</span>
                   <span className="font-bold">10 - 50 kWh</span>
                 </div>
                 <div className="flex justify-between items-center text-sm border-b border-gray-50 pb-2">
                   <span className="text-gray-400 flex items-center gap-2"><Zap className="w-4 h-4"/> Voltage</span>
                   <span className="font-bold">LV (48V)</span>
                 </div>
                 <div className="flex justify-between items-center text-sm border-b border-gray-50 pb-2">
                   <span className="text-gray-400 flex items-center gap-2"><Boxes className="w-4 h-4"/> Install</span>
                   <span className="font-bold">Modular</span>
                 </div>
              </div>

              <Button variant="outline" to="/products/residential" className="w-full justify-between group">
                Specs <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </Button>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400 mb-8 text-sm h-12">For farms and properties at the edge of the grid requiring 3-phase power.</p>

              <div className="space-y-4 mb-8 flex-1">
                 <div className="flex justify-between items-center text-sm border-b border-white/10 pb-2">
                   <span className="text-gray-400 flex items-center gap-2"><Battery className="w-4 h-4"/> Capacity</span>
                   <span className="font-bold text-[var(--renoz-green)]">50 - 200 kWh</span>
                 </div>
                 <div className="flex justify-between items-center text-sm border-b border-white/10 pb-2">
                   <span className="text-gray-400 flex items-center gap-2"><Zap className="w-4 h-4"/> Voltage</span>
                 ...
                 <div className="flex justify-between items-center text-sm border-b border-white/10 pb-2">
                   <span className="text-gray-400 flex items-center gap-2"><Settings2 className="w-4 h-4"/> Type</span>
                   <span className="font-bold">3-Phase Outdoor</span>
                 </div>
              </div>

              <Button variant="primary" to="/products/rural" className="w-full justify-between group">
                Specs <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </Button>
            </motion.div>
            ...
            >
              ...
              <p className="text-[var(--text-muted)] mb-8 text-sm h-12">For industrial applications, microgrids, and large-scale backup.</p>
              ...
              <Button variant="outline" to="/products/commercial" className="w-full justify-between group">
                Specs <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </Button>
            </motion.div>
          </div>
          ...
          <div className="mt-16 text-center max-w-4xl mx-auto">
            ...
            <p className="text-[var(--text-muted)] mb-10">
              Our engineering team can help model your energy usage to determine the optimal system size and configuration.
            </p>

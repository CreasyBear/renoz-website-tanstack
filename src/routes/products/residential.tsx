	...
	head: () => ({
		meta: [
			{ title: "Residential Batteries - RENOZ Energy" },
			{
				name: "description",
				content:
					"10-50kWh home energy storage systems. Power your entire home with genuine security. Engineered for Australian conditions with 10-year warranty.",
			},
			{ property: "og:title", content: "Residential Batteries - RENOZ Energy" },
			{
				property: "og:description",
				content:
					"10-50kWh home energy storage systems. Power your entire home with genuine security. Engineered for Australian conditions.",
			},
			{ property: "og:url", content: `${baseUrl}/products/residential` },
			{
				name: "twitter:title",
				content: "Residential Batteries - RENOZ Energy",
			},
			{
				name: "twitter:description",
				content:
					"10-50kWh home energy storage systems. Power your entire home with genuine security.",
			},
		],
	}),
		...
		>
			...
			<section className="relative h-screen min-h-[800px] flex flex-col justify-center items-center text-center overflow-hidden">
				...
				<div className="relative z-10 max-w-5xl px-4 mt-[-10vh]">
					...
					>
						Energy storage engineered for the Australian climate.{" "}
					...
					>
						<Button
							...
							className="rounded-full px-12 py-6 text-lg shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1"
						>
							Order Now
						</Button>
						<Button
							...
							size="lg"
							to="/resources"
							className="rounded-full px-12 py-6 text-lg bg-white/80 backdrop-blur-md border-white/50 hover:bg-white"
						>
							Specs
						</Button>
					</motion.div>
			...
			<section className="py-32 px-4 max-w-7xl mx-auto">
				<div className="grid lg:grid-cols-2 gap-20 items-center">
					...
					<div>
						<span className="text-[var(--renoz-green)] font-bold tracking-widest uppercase text-sm mb-4 block">
							Modular Design
						</span>
						...
						<p className="text-xl text-[var(--text-muted)] mb-8 leading-relaxed">
							Start with what you need, expand when you want. The RENOZ LV
							system is fully modular. Begin with a single 5kWh module and stack
							up to 40kWh in a single tower as your energy needs grow.
						</p>
							...
							<div className="flex items-start gap-4">
								...
								<div>
									...
									<p className="text-[var(--text-muted)]">
										Add modules without rewiring your entire house.
									</p>
								</div>
							</div>
							<div className="flex items-start gap-4">
								...
								<div>
									...
									<p className="text-[var(--text-muted)]">
										Each stack delivers massive power for pumps, A/C, and EVs.
									</p>
								</div>
							</div>
						</div>
					...
					<div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-white/10">
						...
						>
							<div className="text-4xl md:text-5xl font-bold mb-2">
								10<span className="text-2xl text-[var(--renoz-green)]">yr</span>
							</div>
						...
						>
							<div className="text-4xl md:text-5xl font-bold mb-2">
								5<span className="text-2xl text-[var(--renoz-green)]">kWh</span>
							</div>
							<div className="text-sm text-gray-400 uppercase tracking-widest">
								Per Module
							</div>
						...
						>
							<div className="text-4xl md:text-5xl font-bold mb-2">
								100<span className="text-2xl text-[var(--renoz-green)]">%</span>
							</div>
							<div className="text-sm text-gray-400 uppercase tracking-widest">
								Depth of Discharge
							</div>
						...
						>
							<div className="text-4xl md:text-5xl font-bold mb-2">
								45<span className="text-2xl text-[var(--renoz-green)]">°C</span>
							</div>
							<div className="text-sm text-gray-400 uppercase tracking-widest">
								Heat Rated
							</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
					<div className="text-center max-w-3xl mx-auto mb-20">
						...
						<p className="text-xl text-[var(--text-muted)]">
							...
							Engineered specifically for Western Australian summers, keeping
							your home powered when grid transformers fail in the heat.
						</p>
					</div>
						...
						{[
							{
								...
								desc: "Advanced thermal management keeps cells in their optimal range.",
							},
							{
								icon: Shield,
								title: "LFP Chemistry",
								desc: "Lithium Iron Phosphate is the safest, most stable chemistry available.",
							},
							{
								icon: Zap,
								title: "Surge Proof",
								desc: "Handles high startup currents for air conditioners and pumps.",
							},
						].map((item, i) => (
							<motion.div
								key={i}
							...
							>
								<item.icon
									className="w-10 h-10 text-[var(--renoz-green)] mb-6"
									strokeWidth={1.5}
								/>
					...
					<div className="flex justify-center gap-8 mb-12">
						...
						>
							...
							{activeTab === "specs" && (
								<motion.div
									layoutId="underline"
									className="absolute bottom-0 left-0 w-full h-0.5 bg-[var(--black)]"
								/>
							)}
						</button>
						<button
					...
					{activeTab === "specs" ? (
						...
						>
							{[
								...
								<div
									key={i}
									className="flex items-center justify-between p-6 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors cursor-pointer group"
								>

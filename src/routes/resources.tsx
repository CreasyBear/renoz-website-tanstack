...
import { FileText, Download, Search, Shield, ArrowRight } from 'lucide-react'
...
export const Route = createFileRoute('/resources')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Access technical specifications, installation guides, warranty documentation, and datasheets for all RENOZ battery systems.' },
      { property: 'og:title', content: 'Resources - RENOZ Energy' },
      { property: 'og:description', content: 'Access technical specifications, installation guides, warranty documentation, and datasheets for all RENOZ battery systems.' },
      { property: 'og:url', content: `${baseUrl}/resources` },
      { name: 'twitter:title', content: 'Resources - RENOZ Energy' },
      { name: 'twitter:description', content: 'Access technical specifications, installation guides, warranty documentation, and datasheets for all RENOZ battery systems.' },
    ],
  }),
    ...
    <div className="min-h-screen bg-[var(--cream)]">
      ...
      <section className="bg-[var(--black)] text-white pt-32 pb-24 rounded-b-[40px] shadow-lg mb-16 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Resource Centre</h1>
          <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
            Access technical specifications, installation guides, and warranty documentation for all RENOZ systems.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-32">
        ...
        {filteredDocs.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredDocs.map((doc) => (
              <Card key={doc.id} hover className="flex flex-col h-full bg-white border-none shadow-sm hover:shadow-md transition-all duration-300">
                <div className="flex items-start justify-between mb-4">
                  <div className={`p-3 rounded-xl ${
                    doc.category === 'Warranty' ? 'bg-amber-50 text-amber-600' :
                    doc.category === 'Manual' ? 'bg-purple-50 text-purple-600' :
                ...
                <h3 className="font-bold text-lg mb-2 flex-grow text-[var(--black)] leading-snug">{doc.title}</h3>

                <div className="text-sm text-gray-400 mb-6 flex justify-between items-center border-t border-gray-50 pt-4 mt-2 w-full">
                   <span>{doc.date}</span>
                   <span className="font-mono text-xs bg-gray-100 px-2 py-0.5 rounded">{doc.size}</span>
                </div>
        ...
        <div className="mt-20 bg-gradient-to-br from-[var(--black)] to-[#2d2d2d] text-white rounded-[32px] p-12 md:p-16 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-300 mb-8 leading-relaxed">
              Register your RENOZ system to activate your 10-year replacement warranty. Quick and easy online registration.
            </p>
        ...
        <div className="mt-8 text-center bg-white rounded-[32px] p-12 border border-gray-100 shadow-soft">
           ...
           <p className="text-gray-500 mb-8">Our engineering team can provide specific drawings and compliance documents upon request.</p>
           <div className="flex justify-center gap-4">
              <a href="mailto:support@renoz.energy" className="px-6 py-3 bg-gray-100 hover:bg-gray-200 text-[var(--black)] font-bold rounded-full transition-colors">
                Email Support
              </a>
           </div>
        </div>

...
import { ArrowRight, CheckCircle, XCircle, Shield, FileCheck, Copy, Check } from 'lucide-react'
...
export const Route = createFileRoute('/warranty')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Register your RENOZ battery system warranty. Get official documentation and faster warranty service. Upload photos of your installation for faster approval.' },
      { property: 'og:title', content: 'Register Your Warranty - RENOZ Energy' },
      { property: 'og:description', content: 'Register your RENOZ battery system warranty. Get official documentation and faster warranty service.' },
      { property: 'og:url', content: `${baseUrl}/warranty` },
      { name: 'twitter:title', content: 'Register Your Warranty - RENOZ Energy' },
      { name: 'twitter:description', content: 'Register your RENOZ battery system warranty. Get official documentation and faster warranty service.' },
    ],
  }),
...
const INVERTER_DATA = {
  ...
  "Sungrow": [
    "SH5.0RS (Single Phase LV)",
    "SH10RS (Single Phase LV)"
  ],
  "Growatt": [
    "SPH 3000TL BL-UP",
    "SPH 5000TL BL-UP",
      ...
      <div className="min-h-screen bg-[#F5F5F7] flex items-center justify-center p-4">
        <div className="w-full max-w-2xl">
          ...
          >
            ...
            >
              <p className="text-sm text-gray-500 uppercase font-semibold tracking-wider mb-1">Warranty Reference</p>
              <p className="text-2xl font-mono font-bold text-[var(--renoz-green)] tracking-widest">{warrantyId}</p>
            </motion.div>
            ...
            >
              Thank you for registering your installation. We've sent confirmation emails to you and the homeowner with the official warranty certificate.
            </motion.p>
            ...
            >
              <Button onClick={() => window.location.reload()} variant="outline" className="border-2">
                Register Another System
              </Button>
              <Button asChild className="bg-[var(--renoz-green)] hover:bg-[var(--renoz-green)]/90">
      ...
      <section className="relative h-[40vh] min-h-[300px] flex items-center overflow-hidden bg-[var(--black)] text-white">
        ...
        >
          <div
            ...
            style={{ backgroundImage: "url('/images/case-studies/Harvey-35kWh.jpeg')" }}
          />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full pt-10">
          ...
          >
            ...
            <p className="text-lg text-gray-300 max-w-lg leading-relaxed">
              Secure your investment. Register your RENOZ system to activate your 10-year performance guarantee.
            </p>
          </motion.div>
        </div>
      </section>
              ...
              >
                ...
                <Card className="border-none shadow-xl bg-white p-6 rounded-2xl overflow-hidden relative">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-xs font-bold uppercase text-gray-400 tracking-wider">Reference ID</span>
                ...
                <div className="bg-[var(--black)] text-white p-6 rounded-2xl shadow-xl">
                  ...
                  <ul className="space-y-4">
                    <li className="flex gap-3 text-sm text-gray-300">
                      ...
                      <span><strong>Official Certification</strong><br/>Receive a digital warranty certificate for your property records.</span>
                    </li>
                    <li className="flex gap-3 text-sm text-gray-300">
                      <CheckCircle className="w-5 h-5 text-[var(--renoz-green)] shrink-0" />
                      <span><strong>Priority Support</strong><br/>Direct access to our Perth engineering team for any technical queries.</span>
                    </li>
                    <li className="flex gap-3 text-sm text-gray-300">
                      <CheckCircle className="w-5 h-5 text-[var(--renoz-green)] shrink-0" />
                      <span><strong>Performance Guarantee</strong><br/>Activate your 10-year capacity retention warranty.</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="hidden lg:block bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                  <h4 className="text-xs font-bold uppercase text-gray-400 tracking-wider mb-4">Form Sections</h4>
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={step.id} className="flex items-center gap-3 text-sm">
                        <div className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${step.active ? 'bg-[var(--renoz-green)] text-white' : 'bg-gray-100 text-gray-400'}`}>
                          {step.id}
                        </div>
                        <span className={step.active ? 'font-bold text-[var(--black)]' : 'text-gray-500'}>
                          {step.label}
                        </span>
                      </div>
                    ))}
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <Card className="p-6 md:p-8 rounded-2xl shadow-sm border-none bg-white">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-[var(--black)]">Installer Information</h2>
                    <p className="text-sm text-gray-500">Who is registering this warranty?</p>
                  </div>
                </div>
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-xl border p-4 shadow-sm bg-gray-50/50">
                        <div className="space-y-0.5">
                          ...
                          <FormDescription>
                            Enable this if you are an installer registering on behalf of the homeowner.
                          </FormDescription>
                        </div>
                        <FormControl>
                          <Checkbox
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="w-full">
                          ...
                          <FormControl>
                            <Input placeholder="John Smith" {...field} className="w-full bg-gray-50" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="w-full">
                          ...
                          <FormControl>
                            <Input type="email" placeholder="john@example.com" {...field} className="w-full bg-gray-50" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="w-full">
                          ...
                          <FormControl>
                            <Input type="tel" placeholder="0400 000 000" {...field} className="w-full bg-gray-50" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="w-full">
                          ...
                          <FormControl>
                            <Input placeholder="Acme Solar" {...field} className="w-full bg-gray-50" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="w-full">
                        ...
                        <FormControl>
                          <Input placeholder="EC000000" {...field} className="w-full bg-gray-50" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
              ...
              <Card className="p-6 md:p-8 rounded-2xl shadow-sm border-none bg-white">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-[var(--black)]">Site Information</h2>
                    <p className="text-sm text-gray-500">Where is the system installed?</p>
                  </div>
                </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="w-full">
                        ...
                        <FormControl>
                          <Input placeholder="123 Solar Way" {...field} className="w-full bg-gray-50" autoComplete="street-address" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="w-full">
                          ...
                          <FormControl>
                            <Input placeholder="Perth" {...field} className="w-full bg-gray-50" autoComplete="address-level2" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="w-full">
                          ...
                          <FormControl>
                            <Input placeholder="6000" {...field} className="w-full bg-gray-50" autoComplete="postal-code" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    {onBehalfOfHomeowner && (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-2">
                          <h3 className="text-sm font-bold uppercase tracking-wider text-gray-500">Homeowner Details</h3>
                        </div>
                        <FormField
                          control={control}
                          name="homeownerName"
                          render={({ field }) => (
                            <FormItem className="w-full">
                              ...
                              <FormControl>
                                <Input placeholder="Jane Doe" {...field} className="w-full bg-gray-50" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem className="w-full">
                                ...
                                <FormControl>
                                  <Input type="email" placeholder="jane@example.com" {...field} className="w-full bg-gray-50" />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="w-full">
                              <FormLabel>Homeowner Address (if different)</FormLabel>
                              <FormControl>
                                <Input placeholder="Leave blank if same as installation address" {...field} className="w-full bg-gray-50" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
              ...
              <Card className="p-6 md:p-8 rounded-2xl shadow-sm border-none bg-white">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-[var(--black)]">System Configuration</h2>
                    <p className="text-sm text-gray-500">
                      {nominalCapacity.toFixed(2)} kWh Nominal / {usableCapacity.toFixed(2)} kWh Usable
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <h3 className="text-sm font-bold uppercase tracking-wider text-gray-500">Battery Units</h3>
                      <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-full font-medium">
                        {serialNumbers.filter(s => s.trim()).length} Units Total
                      </span>
                    </div>
                    {serialNumbers.map((_, index) => (
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="w-full">
                            <FormLabel className="text-xs uppercase text-gray-500">Battery {index + 1} Serial</FormLabel>
                            <div className="flex gap-2 w-full">
                              <FormControl className="flex-1">
                                <Input placeholder="e.g., LV51-2515000001" {...field} className="w-full font-mono bg-gray-50" />
                              </FormControl>
                  ...
                  {/* System Specs */}
                  <div className="space-y-4">
                    <h3 className="text-sm font-bold uppercase tracking-wider text-gray-500">System Specs</h3>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="w-full">
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value || "LV-5KWH100AH"}>
                              <FormControl>
                              ...
                              <SelectContent>
                                <SelectItem value="LV-5KWH100AH">LV-5KWH100AH (5.12 kWh)</SelectItem>
                              </SelectContent>
                            </Select>
                            <FormMessage />
                          </FormItem>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <FormField
                        ...
                        name="inverterModel"
                        render={({ field }) => {
                          const selectedBrand = watch('inverterBrand') as InverterBrand | 'Other' | '';
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="w-full">
                            ...
                            <FormControl>
                              <Input placeholder="Serial #" {...field} className="w-full bg-gray-50" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="w-full flex flex-row items-center gap-3 rounded-xl border p-3 bg-gray-50/50 hover:bg-gray-50 transition-colors cursor-pointer">
                            ...
                            <FormLabel htmlFor="pv-checkbox" className="text-sm font-medium cursor-pointer flex-1 mb-0">
                              PV Solar Connected
                            </FormLabel>
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="w-full flex flex-row items-center gap-3 rounded-xl border p-3 bg-gray-50/50 hover:bg-gray-50 transition-colors cursor-pointer">
                            ...
                            <FormLabel htmlFor="genset-checkbox" className="text-sm font-medium cursor-pointer flex-1 mb-0">
                              Backup Generator
                            </FormLabel>
                          </FormItem>
                        )}
                  ...
                  {/* Dates & Purchase */}
                  <div className="space-y-6">
                    <h3 className="text-sm font-bold uppercase tracking-wider text-gray-500">Timeline</h3>
                        ...
                        render={({ field }) => (
                          <FormItem className="w-full">
                            <div className="flex items-center justify-between mb-1">
                              <FormLabel className="mb-0">Purchased From (Optional)</FormLabel>
                              <button
                                type="button"
                                onClick={() => {
                              ...
                              >
                                <Copy className="w-2.5 h-2.5" /> Same as Installer
                              </button>
                            </div>
                            <FormControl>
                              <Input placeholder="Retailer Name" {...field} className="w-full bg-gray-50" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
              ...
              <Card className="p-6 md:p-8 rounded-2xl shadow-sm border-none bg-white">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-[var(--black)]">Evidence & Notes</h2>
                    <p className="text-sm text-gray-500">Installation context and photos</p>
                  </div>
                </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-sm font-bold uppercase tracking-wider text-gray-500">Photo Evidence</h3>
                    <div className="bg-blue-50 p-4 rounded-xl border border-blue-100">
                      <p className="text-sm font-medium text-blue-900 mb-2">Recommended Photos:</p>
              ...
              <Card className="p-6 md:p-8 rounded-2xl shadow-sm border-none bg-white">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-[var(--black)]">Final Declaration</h2>
                ...
                <div className="space-y-6">
                      ...
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-xl border p-4 bg-gray-50">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel className="text-base font-medium">
                            I confirm the batteries have been installed according to RENOZ Energy's installation requirements and user manual *
                          </FormLabel>
                          <FormMessage />
                        </div>
                      </FormItem>
                  ...
                  <div className="pt-4">
                    ...
                    {turnstileError && (
                      <p className="text-red-500 text-sm mt-2 font-medium">Please complete the spam verification.</p>
                    )}
                  </div>
                  ...
                  {submitStatus === 'error' && (
                    ...
                    >
                      ...
                      <div>
                        <p className="font-bold">There was an error submitting your warranty registration.</p>
                        <p className="text-sm mt-1">Please check your information and try again, or contact us directly.</p>
                      </div>
                    </motion.div>
                  )}
                </div>
              ...
              <div className="pt-4">
                <Button
                  ...
                  disabled={isSubmitting || (!turnstileToken && !!import.meta.env.VITE_TURNSTILE_SITE_KEY)}
                >
